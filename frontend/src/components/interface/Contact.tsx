                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-12">
                        <p className="text-lg text-gray-300 max-w-md">
                            Listo para empezar la transformacion. Nuestro equipo encontrará el plan perfecto para ti y responder todas
                            las preguntas que tengas. Contáctanos y te respondemos todas las dudas.
                        </p>

                        <div className="space-y-4">
                            <Title className="text-2xl mb-6">REDES SOCIALES</Title>
