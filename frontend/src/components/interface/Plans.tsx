...
const plans = [
  {
    title: "BICI",
    description: "Descubre los diferentes planes que ofrecemos para adaptarnos a tus necesidades y",
    features: [
  ...
  {
    title: "CARDIO",
    description: "Mejora tu resistencia y quema calorías con nuestras sesiones de cardio",
    features: ["Clases grupales", "Equipamiento moderno", "Rutinas personalizadas", "Evaluación mensual"],
    stats: {
      duration: "30 Mins",
      level: "Medio",
      intensity: "Moderado",
  ...
  {
    title: "PILATES",
    description: "Fortalece tu core y mejora tu flexibilidad con nuestras clases de pilates",
    features: ["Grupos reducidos", "Equipamiento especializado", "Enfoque en postura", "Todos los niveles"],
    stats: {
      duration: "45 Mins",
      level: "Bajo",
      intensity: "Suave",
  ...
  {
    title: "FITBOXING",
    description: "Combina boxeo y fitness para un entrenamiento de alto impacto",
    features: ["Alta quema calórica", "Técnicas de boxeo", "Entrenamiento funcional", "Música motivadora"],
    stats: {
      duration: "50 Mins",
      level: "Alto",
      intensity: "Intenso",
  ...
  {
    title: "YOGA",
    description: "Conecta cuerpo y mente con nuestras sesiones de yoga para todos los niveles",
    features: ["Ambiente relajado", "Instructores certificados", "Mejora flexibilidad", "Reduce estrés"],
    stats: {
      duration: "60 Mins",
      level: "Medio",
      intensity: "Variable",
  ...
  },
  {
    ...
    features: ["Variedad de ejercicios", "Comunidad motivadora", "Resultados rápidos", "Adaptable a tu nivel"],
    stats: {
      duration: "45 Mins",
      level: "Alto",
...
const allProducts = [
  {
    ...
    description: "Conjunto deportivo de alta calidad para máximo rendimiento",
    price: "$59.99",
  ...
  },
  {
    ...
    description: "Suplementos de alta calidad para optimizar tus resultados",
    price: "$29.99",
  ...
  },
  {
    ...
    description: "Zapatillas con soporte y amortiguación para entrenamientos intensos",
    price: "$89.99",
  ...
  },
  {
    ...
    description: "Remera de secado rápido para máxima comodidad durante el entrenamiento",
    price: "$34.99",
  ...
  },
  {
    ...
    description: "Botella de 750ml con medidor de consumo y boquilla antigoteo",
    price: "$19.99",
  ...
  },
  {
    ...
    description: "Set de bandas elásticas con diferentes niveles de resistencia",
    price: "$19.99",
  ...
  },
  {
    ...
    description: "Set de mancuernas con pesos intercambiables para entrenamientos versátiles",
    price: "$129.99",
  ...
  },
  {
    ...
    description: "Esterilla antideslizante de alta densidad para yoga y pilates",
    price: "$39.99",
  ...
  },
  {
    ...
    description: "Cuerda de saltar ajustable con contador digital y empuñaduras ergonómicas",
    price: "$15.99",
...
const fullCatalog = [
  ...allProducts,
  {
    ...
    description: "Bolsa espaciosa con compartimentos para equipo y ropa de entrenamiento",
    price: "$49.99",
  ...
  },
  {
    ...
    description: "Auriculares inalámbricos resistentes al agua y sudor para entrenamientos intensos",
    price: "$79.99",
...
export default function Services() {
  ...
  const handlePlansScroll = () => {
    ...
    const { scrollTop, scrollHeight, clientHeight } = plansContainerRef.current
    const scrollPosition = scrollTop + clientHeight

    // Si estamos cerca del final del scroll, mostrar más planes
    if (scrollHeight - scrollPosition < 100 && visiblePlans < plans.length) {
  ...
  const handleProductsScroll = () => {
    ...
    if (scrollHeight - scrollPosition < 100 && visibleProducts < allProducts.length) {
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
                ...
                {plans.slice(0, visiblePlans).map((plan, index) => (
                  ...
                  >
                    ...
                    <CardContent className="relative h-full z-10 p-6">
                      ...
                      <h3 className="text-white text-3xl font-bold absolute top-6 left-6">{plan.title}</h3>
                          ...
                          <div className="flex justify-between items-center mb-4">
                            <div className="flex items-center gap-4">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-white">{plan.stats.duration}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <Dumbbell className="w-5 h-5 text-white" />
                                <span className="text-sm text-white">{plan.stats.level}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <Battery className="w-5 h-5 text-white" />
                                <span className="text-sm text-white">{plan.stats.intensity}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <User className="w-5 h-5 text-white" />
                                <span className="text-sm text-white">{plan.stats.assistance}</span>
                              </div>
                            </div>
                          </div>
            ...
            <div className="mt-8 text-center">
              <Button className="bg-transparent rounded-xl border">SOLICITAR INFO</Button>
            </div>
          </div>
                ...
                {allProducts.slice(0, visibleProducts).map((product, index) => (
                  ...
                  >
                    ...
                    <CardContent className="p-4">
                      <h3 className="font-bold text-white mb-1 uppercase">{product.title}</h3>
                      <p className="text-gray-400 text-xs line-clamp-2 mb-2">{product.description}</p>
                      <div className="flex justify-between items-center">
                        <span className="gradient-text font-bold">{product.price}</span>
