        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="relative h-full min-h-[400px]">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-2">
              {product.discount && (
                <div className="bg-green-500 px-3 py-1 rounded-full text-sm font-bold">{product.discount} OFF</div>
              )}
              {product.category && (
          ...
          <div className="p-6 bg-gray-900">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              {product.discount && (
                <span className="text-gray-400 line-through text-sm">
                  ${Number.parseFloat(product.price.replace("$", "")) * 1.2}
                </span>
              )}
            </div>
                  ...
                  {product.colors.map((color) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        selectedColor === color ? "ring-2 ring-green-400 ring-offset-2 ring-offset-gray-900" : ""
                      }`}
            ...
            <div className="flex flex-col gap-3 mb-6">
              ...
              <p className="text-xs text-gray-400 text-center">
                Al hacer clic se abrirá WhatsApp con un mensaje predefinido sobre este producto
              </p>
            </div>

            {/* Información adicional */}
            <div className="mt-6 pt-6 border-t border-gray-800">
              <h3 className="text-sm font-medium mb-3">Información adicional</h3>
              <ul className="space-y-2 text-sm text-gray-400">
                <li>• Consulta por disponibilidad de talles y colores</li>
