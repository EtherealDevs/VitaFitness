...
const transformations = [
    {
        ...
        age: 32,
        duration: "3 meses",
        description: "Perdió 15kg y ganó masa muscular siguiendo nuestro programa de entrenamiento personalizado.",
        beforeImage: "https://images.unsplash.com/photo-1583500178450-e59e4309b57a?q=80&w=1000",
        afterImage: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&w=1000",
    },
    {
        name: "Laura S.",
        age: 28,
        duration: "4 meses",
        description: "Mejoró su resistencia y tonificó su cuerpo con nuestras clases de HIIT y nutrición personalizada.",
        beforeImage: "https://images.unsplash.com/photo-1595078475328-1ab05d0a6a0e?q=80&w=1000",
        afterImage: "https://images.unsplash.com/photo-1609899464926-c3d7b56fcf71?q=80&w=1000",
    },
    {
        name: "Miguel A.",
        age: 45,
        duration: "6 meses",
        description: "Superó problemas de espalda y recuperó movilidad gracias a nuestro programa de rehabilitación.",
        beforeImage: "https://images.unsplash.com/photo-1567013127542-490d757e51fc?q=80&w=1000",
        afterImage: "https://images.unsplash.com/photo-1599058917765-a780eda07a3e?q=80&w=1000",
    },
]
...
export default function CommitmentSection() {
    ...
    return (
        <section className="py-16 bg-black">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-gray-900/50 p-6 rounded-lg border-l-4 border-gradient relative overflow-hidden group">
                            ...
                            <h2 className="text-2xl text-white mb-4 font-bold">¿POR QUÉ ELEGIR A VITA?</h2>
                            <p className="text-gray-300 relative z-10">
                                The smartest & most effective workout in 50 minutes. VITA is functional fitness at it's finest & will
                                have your body feeling strong & sculpted fast.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Card className="relative h-[200px] overflow-hidden group">
                                    ...
                                    <div className="absolute inset-0 p-4 flex flex-col justify-between">
                                        <h3 className="text-2xl font-bold text-white">CORRIENTES I</h3>
                                        <div>
                                            <p className="text-gray-200 text-sm mb-2">Avenida Ferre 1567</p>
                                ...
                                <Card className="relative h-[200px] overflow-hidden group">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                                    <div className="absolute inset-0 p-4 flex flex-col justify-between">
                                        <h3 className="text-2xl font-bold text-white">CORRIENTES II</h3>
                                        <div>
                                            <p className="text-gray-200 text-sm mb-2">España y Belgrano</p>
                                            <button className="text-green-400 text-sm flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                Ver mapa <ArrowRight className="w-3 h-3" />
                                            </button>
                                        </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="absolute inset-0 p-6 flex flex-col justify-between">
                                ...
                                <div>
                                    <p className="text-gray-200 mb-3">
                                        En vita fitnes nuestros miembros experimentan mejoras en resistencia, cardio, energía
                                    </p>
                        ...
                        <Card className="relative h-[250px] overflow-hidden group">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent"></div>
                            <div className="absolute inset-0 p-6 flex flex-col justify-between">
                                <h3 className="text-3xl font-bold text-white">NUESTRA VISION</h3>
                                <div>
                                    <p className="text-gray-200 mb-3">
                                        En vita fitness nuestra visión es ofrecer un ambiente inclusivo y motivador donde cualquier persona
                                        pueda alcanzar sus objetivos de bienestar y salud.
                                    </p>
                                    <button className="text-green-400 text-sm flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <div className="relative">
                        ...
                        <div className="overflow-hidden">
                            <div
                                ...
                                style={{ transform: `translateX(-${activeTransformation * 100}%)` }}
                            >
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 items-center">
                                            ...
                                            <div className="p-6 bg-gray-900/50 rounded-lg">
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <p className="text-sm text-gray-400">Porcentaje de objetivos alcanzados</p>
                                                </div>
                        ...
                        <div className="flex justify-center gap-2 mt-8">
                            {transformations.map((_, index) => (
                                <button
                                    key={index}
                                    className={`w-3 h-3 rounded-full transition-all duration-300 ${index === activeTransformation ? "bg-gradient-to-r from-green-400 to-purple-500 w-8" : "bg-gray-600"
                                        }`}
            ...
            <style jsx global>{`
        .border-gradient {
          border-image: linear-gradient(to bottom, #4ade80, #a855f7) 1 100%;
        }
      `}</style>
        </section>
    )
