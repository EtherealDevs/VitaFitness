        ...
        <section id="commitment" className="py-16 bg-black">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="relative overflow-hidden rounded-lg">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end p-4">
                                        <h3 className="text-2xl font-bold text-white">CORRIENTES</h3>
                                        <p className="text-gray-300">Avenida Ferre 15667</p>
                                    </div>
                                </div>
                                <div className="relative overflow-hidden rounded-lg">
                                    <img
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end p-4">
                                        <h3 className="text-2xl font-bold text-white">CORRIENTES</h3>
                                        <p className="text-gray-300">España y Belgrano</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div className="mb-12">
                            <h3 className="text-2xl font-bold mb-4">¿POR QUÉ ELEGIR A VITA?</h3>
                            <p className="text-gray-300">
                                The smartest & most effective workout in 50 minutes. VITA is functional fitness at its finest & will
