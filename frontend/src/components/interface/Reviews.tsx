...
const reviews = [
    ...
    },
    {
        name: 'Carlos R.',
        comment:
            'Las instalaciones son de primera y el personal siempre está dispuesto a ayudar.',
        rating: 5,
        avatar: '/placeholder.svg?height=50&width=50',
    },
    {
        name: 'Ana L.',
        comment:
            'Me encanta la variedad de clases. Nunca me aburro de mi rutina de ejercicios.',
        rating: 4,
        avatar: '/placeholder.svg?height=50&width=50',
    },
    {
        name: 'Juan P.',
        comment:
            'El plan premium vale cada centavo. Mi entrenador personal es excepcional.',
        rating: 5,
        avatar: '/placeholder.svg?height=50&width=50',
    },
]
    ...
    return (
        <section id="reviews" className="py-16 bg-gray-900">
            <div className="container mx-auto px-4">
                <GradientTitle className="text-center">
                    Reseñas y Galería
                </GradientTitle>
                        ...
                        <div className="relative h-[400px] overflow-hidden">
                            <div
                                ...
                                {reviews.map((review, index) => (
                                    <Card
                                        key={index}
                                        className="bg-black border-gray-800 mb-4 snap-center">
