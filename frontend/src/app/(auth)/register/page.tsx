    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      ...
      <div className="hidden md:block md:w-1/2 relative">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center items-center p-12">
          ...
          <h1 className="title-font text-6xl mb-6 text-white text-center">ÚNETE A NOSOTROS</h1>
          <p className="text-xl text-gray-200 text-center max-w-md">
            Comienza tu transformación hoy. Regístrate para acceder a todos nuestros servicios y comenzar tu camino
      ...
      {/*       <Logo size="lg" /> */}
          ...
          <div className="w-full max-w-md">
            <div className="bg-zinc-900 rounded-lg shadow-lg p-8 border border-zinc-800">
              <h2 className="title-font text-4xl mb-6 text-center gradient-text">REGISTRO</h2>

              <form onSubmit={submitForm} className="space-y-6">
                {/* Name */}
                <div>
                  <label htmlFor="name" className="title-font text-lg text-white block mb-2">
                    Nombre
                  </label>
                  ...
                  {errors.name && <p className="mt-2 text-sm text-red-500">{errors.name.join(", ")}</p>}
                </div>
                ...
                {/* Confirm Password */}
                <div>
                  <label htmlFor="passwordConfirmation" className="title-font text-lg text-white block mb-2">
                  ...
                  {errors.password_confirmation && (
                    <p className="mt-2 text-sm text-red-500">{errors.password_confirmation.join(", ")}</p>
                  )}
                </div>
            ...
            <div className="mt-12 space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="title-font text-white text-lg">Acceso a planes exclusivos</h3>
                  <p className="text-sm text-gray-400">Desbloquea planes de entrenamiento personalizados</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="bg-teal-400/10 p-2 rounded-full mr-4 mt-1">
                ...
                <div>
                  <h3 className="title-font text-white text-lg">Seguimiento de progreso</h3>
                  <p className="text-sm text-gray-400">Monitorea tus avances y resultados</p>
                </div>
              </div>
            </div>
          </div>
